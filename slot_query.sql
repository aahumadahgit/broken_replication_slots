SELECT active_pid, slot_name, pg_size_pretty(pg_wal_lsn_diff(pg_current_wal_lsn(),restart_lsn))
AS replicationSlotLag, active, pg_stat_replication.reply_time as LastReply
FROM pg_replication_slots JOIN pg_stat_replication ON pg_replication_slots.active_pid = pg_stat_replication.pid;
